...
SEED_PIECES = [
    {
        ...
        "quantite_stock": 10,
        "image": "garage/img/pieces/courroie-distribution.jpg",
    },
    {
        ...
        "quantite_stock": 5,
        "image": "garage/img/pieces/alternateur.jpg",
    },
    {
        ...
        "quantite_stock": 8,
        "image": "garage/img/pieces/pompe-a-eau.jpg",
    },
    {
        ...
        "quantite_stock": 12,
        "image": "garage/img/pieces/amortisseur.jpg",
    },
    {
        ...
        "quantite_stock": 20,
        "image": "garage/img/pieces/capteur-tpms.jpg",
    },
    {
        ...
        "quantite_stock": 3,
        "image": "garage/img/pieces/joint-culasse.jpg",
    },
]


def get_seed_piece_images():
    return {item["reference"]: item["image"] for item in SEED_PIECES if item.get("image")}
...
def seed_pieces():
    from garage.models import Garage, Piece
